...
| Generation marker (`start_time`) to detect LUT change | Fires on a LUT-job restart with identical config, wiping consumer statistics mid-run. Rejected in favour of a producer-stamped fingerprint. |
