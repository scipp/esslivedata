...
def test_out_of_order_timestamps_are_skipped():
    ...
    accumulator.add(0, LogData(time=10, value=1.0))  # out of order, skipped
    accumulator.add(0, LogData(time=20, value=2.0))  # out of order, skipped
    accumulator.add(0, LogData(time=40, value=4.0))  # in order, accepted
...
def test_out_of_order_array_data_is_skipped():
    ...
    accumulator.add(timestamp=0, data=LogData(time=3000000, value=[30.0, 31.0]))
    accumulator.add(timestamp=0, data=LogData(time=1000000, value=[10.0, 11.0]))
    accumulator.add(timestamp=0, data=LogData(time=2000000, value=[20.0, 21.0]))
