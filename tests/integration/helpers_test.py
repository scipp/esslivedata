...
class TestGetWorkflowJobs:
    ...
    def test_returns_only_matching_workflow(self):
...
class TestGetWorkflowJobData:
    ...
    def test_filters_by_source_names(self):
    ...
    def test_excludes_jobs_with_no_matching_sources(self):
...
class TestWaitForWorkflowJobData:
    ...
    def test_succeeds_when_data_arrives(self):
        ...
        def simulate_data_arrival():
            if backend.update_count == 2:
                job_service.job_info[make_job_number(1)] = make_workflow_id(
                    'workflow_a'
                )
                job_service.job_data[make_job_number(1)] = {
                    'source1': {'output1': 'data'}
                }
    ...
    def test_must_not_succeed_for_wrong_workflow(self):
    ...
    def test_must_not_succeed_for_wrong_source(self):
    ...
    def test_succeeds_with_any_requested_source(self):
