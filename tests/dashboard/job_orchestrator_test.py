...
# Data retention/eviction across commit and stop is covered by
# tests/dashboard/restart_cleanup_test.py, which exercises the real ingest
# path (Orchestrator.forward + generation filter) instead of writing keys
# into DataService directly.
