...
from ess.livedata.workflows.detector_view.projectors import make_logical_projector
from ess.livedata.workflows.detector_view.providers import (
...
from ess.livedata.workflows.detector_view.workflow import (
