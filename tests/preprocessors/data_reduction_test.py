...
class TestReductionPreprocessorFactory:
    @pytest.fixture
    ...
    def factory(self, instrument_with_logs):
        """Create ReductionPreprocessorFactory instance."""
        return ReductionPreprocessorFactory(instrument=instrument_with_logs)
    ...
    def test_make_preprocessor_monitor_counts(self, factory):
        ...
        from ess.livedata.preprocessors.accumulators import Cumulative
    ...
    def test_make_preprocessor_monitor_events(self, factory):
        ...
        from ess.livedata.preprocessors.to_nxevent_data import ToNXevent_data
