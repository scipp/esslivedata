...
from ess.livedata.preprocessors.detector_view_specs import CoordinateModeSettings
from ess.livedata.preprocessors.monitor_workflow import (
    MONITOR_TRANSFORM,
...
from ess.livedata.preprocessors.monitor_workflow_types import (
