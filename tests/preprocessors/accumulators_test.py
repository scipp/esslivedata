...
@pytest.mark.parametrize(
    'accumulator_cls', [Cumulative, LatestValueAccumulator, ToNXevent_data]
)
...
class TestLatestValueAccumulator:
    """Tests for LatestValueAccumulator (context accumulator with add/get/clear)."""

    def test_get_before_add_raises_error(self) -> None:
        accumulator = LatestValueAccumulator()
        with pytest.raises(ValueError, match="No data has been added"):
            accumulator.get()
