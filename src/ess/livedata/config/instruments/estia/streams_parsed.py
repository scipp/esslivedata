...
PARSED_STREAMS: list[F144Stream] = [
    F144Stream(
        stream_name='analyzer_stage_analyzer_adjustment',
    ...
    F144Stream(
        stream_name='analyzer_stage_analyzer_lift',
    ...
    F144Stream(
        stream_name='detector_arm_detector_rotation',
    ...
    F144Stream(
        stream_name='middle_focus_changer_horizontal_adjustment',
    ...
    F144Stream(
        stream_name='middle_focus_changer_mask_changer',
    ...
    F144Stream(
        stream_name='middle_focus_changer_vertical_adjustment',
    ...
    F144Stream(
        stream_name='polarizer_stage_angle_adjustment',
    ...
    F144Stream(
        stream_name='polarizer_stage_in_beam_changer',
    ...
    F144Stream(
        stream_name='sample_stage_goniometer',
    ...
    F144Stream(
        stream_name='virtual_source_slit_rotation_stage',
