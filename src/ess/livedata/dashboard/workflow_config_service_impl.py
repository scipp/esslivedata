...
"""
Implementation of WorkflowConfigService using backend abstractions.
...
class WorkflowConfigServiceImpl(WorkflowConfigService):
    """
    Implementation of WorkflowConfigService using backend message abstractions.
    ...
    def process_config_item(self, raw_item: RawConfigItem) -> None:
        ...
        try:
            ...
            self._logger.exception("Error processing config item")
