...
class WorkflowController:
    ...
    def __init__(
        ...
        *,
        ...
        job_orchestrator
            ...
            The orchestrator provides the combined workflow registry
            (static + dynamically created from templates).
        data_service
    ...
    @property
    def _workflow_registry(self) -> Mapping[WorkflowId, WorkflowSpec]:
        """Get the workflow registry from the orchestrator."""
        return self._orchestrator.workflow_registry
